...
function pixiPianoRoll(opt) {
    ...
    let keys,
        ...
        renderer.resize(window.innerWidth, opt.height);
    ...
    function transportTimeToX(transportTime, isNote) {
        ...
        const x = transportTime / (opt.bpm / 60) * barWidth   
    ...
    function drawNotes() {
        ...
        for (let [transportTime, note, duration] of opt.noteData) {
            console.log([transportTime, note, duration]);
            console.log([duration, innerNoteHeight]);
            ...
            console.log(pixiNote.x);
            console.log(pixiNote.y);

            pixiNote.keyNumber = keyNumber;

            console.log(pixiNote.keyNumber);
